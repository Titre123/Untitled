...
import Mobile from "../assets/login.jpeg";
  ...
  return (
    <div className="LogoPageWithImage h-screen w-screen overflow-hidden flex ipad:bg-gray-100">
      <div className="LoginPage h-full w-full py-12 ipad:bg-white ipad:py-0 ipad:w-[50%] relative">
        ...
        <div className="Container px-4 tablet:px-0 mx-auto max-w-[400px] h-full w-full ipad:my-auto flex flex-col gap-y-6 ipad:absolute ipad:top-[50%] ipad:translate-y-[-50%] ipad:left-[50%] ipad:translate-x-[-50%] ipad:h-max">
          <div className="Header flex flex-col gap-y-6 ipad:block">
            ...
            <div className="Welcome gap-2 flex flex-col ipad:gap-3">
      ...
      <div className="LoginImage hidden ipad:flex w-[50%] relative">
        <div className="right-[0px] top-[-40%] absolute">
          <LoginPattern />
        </div>
        <div className="ImageDiv h-[75%] aspect-[3/2] absolute top-[50%] translate-y-[-50%] left-[15%] z-10">
          <img src={Mobile} className="h-full block" />
        </div>
        <div className="absolute left-[0px] bottom-[-40%]">
          <LoginPattern />
        </div>
      </div>
    </div>
